            ...
            <div className="flex gap-5 items-center">
              {linkDeploy ? (
                <a href={linkDeploy} target="_blank" rel="noopener noreferrer">
                  <button className="transition ease-in-out text-white bg-button shadow-shadow_button font-bold text-lg p-2 rounded-lg hover:opacity-90 hover:-translate-y-1 hover:scale-110 duration-300">
                    Ver Projeto
                  </button>
                </a>
              ) : (
